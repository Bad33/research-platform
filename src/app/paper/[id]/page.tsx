...
export default function PaperDetailView({ paper }: { paper: any }) {
  // Normalize escaped newline characters from API responses
    ...
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 antialiased">
      ...
      <header className="border-b border-zinc-200/80 bg-white/80 backdrop-blur-md sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between text-sm">
          <span className="font-semibold tracking-tight text-zinc-900">Synthetica</span>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <article className="lg:col-span-7 space-y-8">
            ...
            {/* Redesigned Key Takeaways / Executive Brief */}
            <div className="rounded-xl border border-zinc-200/80 bg-gradient-to-b from-zinc-50/50 to-white p-6 shadow-[0_2px_8px_-4px_rgba(0,0,0,0.04)]">
          ...
          <aside className="lg:col-span-5 space-y-6 lg:sticky lg:top-20">
            ...
            <div className="rounded-xl border border-zinc-200/80 bg-white p-5 shadow-sm">
              ...
              <div className="h-56 w-full text-xs">
                {paper.chart_data_json?.data_points ? (
                  ...
                  <div className="h-full flex items-center justify-center text-zinc-400">No chart data available</div>
                )}
              </div>
            </div>
            ...
            <div className="rounded-xl border border-zinc-200/80 bg-white p-5 shadow-sm space-y-3">
              ...
              <p className="text-xs text-zinc-600">
                Ask Gemini technical questions about this paper's methodology or underlying dataset.
              </p>
              <div className="relative flex items-center">
                <input 
                  type="text"
                  placeholder="e.g., What controls were used?"
